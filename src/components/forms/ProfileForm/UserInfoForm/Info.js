...
export default function Info () {
  ...
  return (
    <Col id='userInfo'>
      <h4 className='px-2' style={{ color: '#54a444' }}>
        Suas informações
      </h4>
      <div className='d-block px-2'>
        <label htmlFor='name' className='custom-text'>
          Nome: *
        </label>
        <input
          type='text'
      ...
      <Row>
        <Col>
          <label htmlFor='email' className='custom-text'>
            E-mail: *
          </label>
          <input
            type='email'
        ...
        <Col>
          <label htmlFor='phone' className='custom-text'>
            Celular: *
          </label>
          <input
            type='text'
      ...
      <Row>
        <Col>
          <label htmlFor='doctype' className='custom-text'>
            Documento: *
          </label>
          <select
            value={docType}
            name='doctype'
            onChange={event => handleDocType(event)}
          >
        ...
        <Col>
          <label htmlFor='docvalue' className='custom-text'>
            Nº Documento: *
          </label>
          <input
            type='text'
